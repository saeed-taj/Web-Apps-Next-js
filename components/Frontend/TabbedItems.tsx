...
import LinkCard from "./Lawyers/LinkCard";
import { FileUser, LockOpen, Scale, Video } from "lucide-react";
...
export default function TabbedItems() {
  ...
  const tabs = [
    { 
      ...
      icon: FaFire,
      component : <ServiceList services={topServices}/>,
      content : []
    },
    { 
      title: "Lawyers", 
      icon: FaGavel,
      component : <LinkCard className=""/>,
      content : []
